...
function App() {
    ...
    return ( <
        ...
        onClick = { touchDownHOME } > Home Grand Slam! < /button> <
        button className = "homeButtons__fieldGoal"
        onClick = { fieldGoalHOME } > Home Home Run! < /button> < /
        div > <
        div className = "awayButtons" >
        <
        button className = "awayButtons__touchdown"
        onClick = { touchDownAWAY } > Away Grand Slam! < /button> <
        button className = "awayButtons__fieldGoal"
        onClick = { fieldGoalAWAY } > Away Home Run! < /button> < /
        div >
